...
class Author:
    ...
    def magazines(self):
     set_unique_magazines = {article.magazine for article in self._articles}
     return list(set_unique_magazines)

    def topic_areas(self):
        if not self._articles:
            return None
        set_unique_categories = {article.magazine.category for article in self._articles}
        return list(set_unique_categories)
